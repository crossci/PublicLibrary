...
inline void strCoding::Gb2312ToUnicode(WCHAR* pOut, char *gbBuffer)
{
	::MultiByteToWideChar(CP_ACP, MB_PRECOMPOSED, gbBuffer, 2, pOut, 1);
	return;
}
inline void strCoding::UTF_8ToUnicode(WCHAR* pOut, char *pText)
{
...
inline void strCoding::UnicodeToUTF_8(char* pOut, WCHAR* pText)
{
...
inline void strCoding::UnicodeToGB2312(char* pOut, WCHAR uData)
{
...
inline char strCoding::StrToBin(char *str){
	char tempWord[2];
	char chn;
...
//UTF_8 转gb2312
inline void strCoding::UTF_8ToGB2312(string &pOut, char *pText, int pLen)
{
	char buf[4];
...
//GB2312 转为 UTF-8
inline void strCoding::GB2312ToUTF_8(string& pOut, char *pText, int pLen)
{
	char buf[4];
	memset(buf, 0, 4);
...
inline string strCoding::UrlGB2312(char * str)
{
	string dd;
...
inline string strCoding::UrlUTF8(char * str)
{
	string tt;
	string dd;
...
//把url GB2312解码
inline string strCoding::UrlGB2312Decode(string str)
{
	string output = "";
	char tmp[2];
...
//把url utf8解码
inline string strCoding::UrlUTF8Decode(string str)
{
	string output = "";
